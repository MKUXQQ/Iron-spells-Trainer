...
public final class SpellProjectileBalanceEvents {
    ...
    public static void onSpellPreCast(SpellPreCastEvent event) {
        ...
        SpellBalanceValues values = SpellBalanceStore.valuesFor(new ResourceLocation(event.getSpellId()));
    ...
    public static void onSpellCast(SpellOnCastEvent event) {
        ...
        if (caster != null) {
            RECENT_CASTS.put(caster.getUUID(), new RecentCast(
                    new ResourceLocation(event.getSpellId()),
    ...
    public static void onEntityJoinLevel(EntityJoinLevelEvent event) {
        ...
        if (values == null || values.projectileSpeed() == 1.0) {
            return;
        }
        multiplyNumberField(projectile, speedField(), values.projectileSpeed());
        projectile.setDeltaMovement(projectile.getDeltaMovement().scale(values.projectileSpeed()));
    }
